...
**[Download v0.3.4](https://github.com/Shiffo0/MGS2-PCVR/releases/tag/v0.3.4)** · [Installation](#installation) · [Controls](#controls) · [Known limitations](#known-limitations) · [Report a problem](https://github.com/Shiffo0/MGS2-PCVR/issues)
...
3. Download **`MGS2-PCVR-v0.3.4-0237AC10.zip`** from the [release page](https://github.com/Shiffo0/MGS2-PCVR/releases/tag/v0.3.4). Choose the mod ZIP under **Assets**, not GitHub's automatic **Source code** downloads.
...
- **Known regression in v0.3.4: entering lockers from first-person (FPS) mode is broken.**
...
Future work focuses on **Raiden and the Plant chapter**, including SOCOM mapping, coolant interactions, scope and sniper-rifle support, further Stinger work, and Nikita support. Hanging and grenades also need more work. There is no release date for complete Raiden support yet.
...
- **VR stops after about an hour:** install v0.3.4, close the game and set `seconds=0` in `dg_hook.on`.
