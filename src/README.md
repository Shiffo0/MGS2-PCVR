...
Corresponding release mod source for **v0.3.5**, build **1007DD0B**. This directory contains the mod's shipping dependency closure and build script.
